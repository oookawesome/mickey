...
description: MSA프로젝트에 TE로 참여하면서 프로젝트에 Contract Test를 적용했었던 일에 대한 정리 및 회고 # Add post description (optional)
image: 
    feature: pain.png
    topPosition: -50px
...
![spring cloud contract](../assets/img/spring-cloud-contract.png)
